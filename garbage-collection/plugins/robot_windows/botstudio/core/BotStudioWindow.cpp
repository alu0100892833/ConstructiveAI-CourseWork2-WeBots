...
void BotStudioWindow::createActions() {
  ...
  mNewTransitionAct = new QAction(QIcon(BotStudioPaths::getIconsPath() + "new_transition.xpm"), tr("&New Transition Tool"), this);
...
void BotStudioWindow::createDockWindows() {
  ...
  mRemoteControlDock->setFeatures(mRemoteControlDock->features() & ~QDockWidget::DockWidgetFloatable & ~QDockWidget::DockWidgetClosable);
  ...
  mSwitchWidgetDock->setFeatures(mSwitchWidgetDock->features() & ~QDockWidget::DockWidgetFloatable & ~QDockWidget::DockWidgetClosable);
